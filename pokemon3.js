//Q2(sub question 3)
//Javascript to find the names of all pokemons have weakness given by user
var data={
    "pokemon": [{
      "id": 1,
      "num": "001",
...
// names of all pokemons who have Weakness given by user . 
//function defination
function pokemonWeaknes(weaknes)
{

  var WeaknessFound=false;                                         //PokemonFound is used to check wether given 
   
  for(Pokemon in data.pokemon)                                  //This loop will run for all objects in pokemon
   
  {
     
    for(weaknesInPokemon in data.pokemon[Pokemon].weaknesses)   //This loop will run for all items in weaknesses array 
       
    {
          
      if(data.pokemon[Pokemon].weaknesses[weaknesInPokemon] == weaknes)  //checking the name in the dataset and name given by user

      {
          
        alert(data.pokemon[Pokemon].name)                  //program alerts the name of pokemon
...
WeaknessFound==false? alert("No such weakness found in any of the Pokemon"): alert("--END--")

}

//program starts from here
alert(" Names of all pokemon who have the given Weakness.")
var weaknes = prompt("Enter a Weakness")  //Taking input from user
pokemonWeaknes(weaknes)                    //calling the function
