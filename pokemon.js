//Q2(sub question 1)
//Javascript for evaluating information of Pokemon
var data = {
    "pokemon": [
        {
      "id": 1,
...
//Information of a Pokemon
  function PokemonInfo(NameOfPokemon)                  //function defination with name as Parameter
  {

    var PokemonFound=false                            //flag is used to check if pokemon with given name is present or not

     for(currentPokemon in data.pokemon)                   //The loop will run for all the objects in pokemon
     {    
         
      if(data.pokemon[currentPokemon].name==NameOfPokemon)       //Matching name of the pokemon in datset and name given by user
      {
            //Information of a pokemon
           
            alert("Name: "+data.pokemon[currentPokemon].name)  
            
            alert("id "+data.pokemon[currentPokemon].id)
            
            alert("num: "+data.pokemon[currentPokemon].num)
            
            alert("img: "+data.pokemon[currentPokemon].img)
            
            alert("type: "+data.pokemon[currentPokemon].type)
            
            alert("height: "+data.pokemon[currentPokemon].height)
            
            alert("weight: "+data.pokemon[currentPokemon].weight)
            
            alert("candy:"+data.pokemon[currentPokemon].candy)
            
            alert("candy_count:"+data.pokemon[currentPokemon].candy_count)
            
            alert("egg "+data.pokemon[currentPokemon].egg)
            
            alert("spawn chance: "+data.pokemon[currentPokemon].spawn_chance)
            
            alert("multipliers"+data.pokemon[currentPokemon].multipliers)
            
            alert("weakness: "+data.pokemon[currentPokemon].weaknesses)
            
            for(j in data.pokemon[currentPokemon].next_evolution)
            {
               
              alert("next evolution:  " +data.pokemon[currentPokemon].next_evolution[currentPokemon].name)
     ...
     //Ternary condition to alert if there is no match
     
     PokemonFound==false? alert("No pokemon with name:"+"'"+NameOfPokemon+"'"):alert("--END--") 
  
    }


//Program starts from here
alert("Information of a Pokemon")
var name = prompt("Enter the name of the Pokemon for its information") // taking input from user using prompt
PokemonInfo(name)                                                      //Function call with "name" as argument   
