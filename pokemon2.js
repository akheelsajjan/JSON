//Q2(sub question 2)
//Javascript to find out which all pokemon have same name in next_evolution field
var data={
    "pokemon": [{
      "id": 1,
      "num": "001",
  ...
  //To check pokemons that have same name in their “next_evolution” field
  //function starts from here
  function PokemonMatch(nameOfPokemon)
  {
    
    var PokemonFound = false;                      //PokemonFound is used to check wether a pokemon is present or not
    
    for(currentPokemon in data.pokemon)             //This loop will run for all objects in pokemon
    
    {
    
      for(NextEvolutionPokemon in data.pokemon[currentPokemon].next_evolution)    //This loop will run only for items present in the next_evolution
    
      {
    
        if(data.pokemon[currentPokemon].next_evolution[NextEvolutionPokemon].name==nameOfPokemon) //checking the name in the dataset and name given by user
    
        {
    
          alert(data.pokemon[currentPokemon].name)                     //program alerts the name of pokemon
    ...
    PokemonFound==false? alert("Not Found"): alert("--END--")       //Ternary condition to alert if there is no match
 
  }

 //Program starts from here
 alert(" To check pokemons that have same name in their “next_evolution” field")
 var name = prompt("Enter The name of Pokemon")  //Taking input from user using prompt 
 PokemonMatch(name);                             //calling the function